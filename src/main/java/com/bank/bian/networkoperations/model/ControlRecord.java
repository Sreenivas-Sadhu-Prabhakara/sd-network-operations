package com.bank.bian.networkoperations.model;
...
/**
 * The BIAN control record for this service domain: "Network Service Operating Session".
 *
 ...
 * to its asset type (Network Service). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Network Service Operating Session";
